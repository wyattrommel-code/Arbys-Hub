...
/** Photo or signature — uses camera/upload flow. */
export function isCaptureMethod(method) {
  return method === "photo" || method === "photo_ai" || method === "signature";
}

export function isSignatureMethod(method) {
  return method === "signature";
}

export function hasCompletionImage(completion) {
  return Boolean(completion?.photo_url);
}
