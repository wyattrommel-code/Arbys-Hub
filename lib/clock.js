 ...
 */
export async function ensurePublicPhotoBucket(supabase, bucket) {
...
export async function ensurePunchPhotosBucket(supabase) {
  await ensurePublicPhotoBucket(supabase, PUNCH_PHOTOS_BUCKET);
}

export async function ensureProfilePhotosBucket(supabase) {
  await ensurePublicPhotoBucket(supabase, PROFILE_PHOTOS_BUCKET);
}
