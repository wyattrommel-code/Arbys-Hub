...
export const SIDEBAR_NAV = [
  ...
  { href: "/schedule/builder", label: "Schedule Builder", icon: "calendar-plus", feature: "schedule.full" },
  { href: "/schedule/me", label: "My Schedule", icon: "calendar-days", feature: "schedule.own" },
