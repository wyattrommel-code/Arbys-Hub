 ...
 * @param {string | { access_tier?: string, role?: string } | null | undefined} empOrRole
 */
export function canApproveOffers(empOrRole) {
  if (empOrRole && typeof empOrRole === "object") {
    return isGmOrAssistantManager(empOrRole.access_tier || empOrRole.role);
  }
